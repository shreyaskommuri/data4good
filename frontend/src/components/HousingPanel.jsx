      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
        ...
        <div>
          <div style={{ fontSize: '1.1rem', fontWeight: 700, display: 'flex', alignItems: 'center' }}>
            ...
            <Tooltip content="This index scores each jurisdiction from <strong>0 (no pressure) to 100 (extreme pressure)</strong> based on how much housing supply constrains climate resilience. A higher score means <strong>fewer housing options for displaced workers</strong> after a climate event.<br/><br/><strong>Calculation:</strong> Housing Pressure Index = 0.4 × RHNA deficit + 0.3 × affordable unit shortage + 0.15 × ADU over-reliance + 0.15 × rental tightness<br/><br/>• <strong>RHNA Deficit (40%):</strong> How far behind on state-mandated Regional Housing Needs Assessment targets<br/>• <strong>Affordable Unit Shortage (30%):</strong> Gap between affordable housing need and supply<br/>• <strong>ADU Over-Reliance (15%):</strong> Over-dependence on Accessory Dwelling Units vs. multi-family housing<br/>• <strong>Rental Market Tightness (15%):</strong> Vacancy rates and rental availability<br/><br/>Data from SBCAG 2024 Annual Progress Report (APR)." />
          </div>
